...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 SITHUWA 𝐌𝐃';
const footerText = 'SITHUWA 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
...
socket.sendMessage(from, buttonMessage, { quoted: msg });
    ...
    const captionText = `
╭────◉◉◉────៚\n⏰ Bot Uptime: ${hours}h ${minutes}m ${seconds}s\n🟢 Active Bots: ${activeSockets.size}\n╰────◉◉◉────៚\n\n🔢 Your Number: ${number}\n\n*▫️SITHUWA 𝐌𝐃  Main Website 🌐*\n> https://SITHUWA-md-mini-bot.vercel.app/
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/letrek.jpg" },
        caption: `SITHUWA 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
...
`;
    ...
    await socket.sendMessage(from, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: `✨ *Welcome to SITHUWA 𝐌𝐃 MINI BOT* ✨\n\n${menuText}\n\n> 🚀 Powered by SITHUWA 𝐌𝐃`
    });
    ...
    try {
        ...
        if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_SEEN) {
            ...
            if (config.AUTO_STATUS_REPLY) {
                const customMessage = config.STATUS_READ_MSG || '*✅ Auto Status Seen Bot By SITHUWA 𝐌𝐃*';
...
case 'badsithuwa': {
    try {
        ...
        let txt = `*👑 SITHUWA 𝐌𝐃 DEPLOYERS LIST*\n\n`;
        let count = 1;
        ...
        console.error("❌ SITHUWA 𝐌𝐃 plugin error:", err);
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "SITHUWA 𝐌𝐃 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 SITHUWA 𝐌𝐃" },
                ...
                case 'winfo':
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Invalid phone number!(පකයට බුලත් දෙන්න බැ +94 ගහපම්)(e.g., +94761953182)',
                                '> SITHUWA 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
                            )
                        });
                        break;
    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            await socket.sendMessage(sender, {
                video: { url: videoUrl },
                mimetype: 'video/mp4',
                caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 SITHUWA 𝐌𝐃  𝐌 𝐃'
            }, { quoted: msg });
...
case 'ping': {
  ...
  if (!q || q.trim() === '') {
    return await socket.sendMessage(sender, {
      text: "ඕ කියන්න අනේ් මම SITHUWA 𝐌𝐃 AI🤭"
    }, { quoted: msg });
  }

  const prompt = `ඔබගේ නම SITHUWA 𝐌𝐃 𝐀𝐈.  
...
"කව්ද ඔයා" කියනවා නම්:  
👉 "මම SITHUWA 𝐌𝐃 AI… 🤤" කියන්න.

"ඔයාව හැදුවේ කවුද" කියනවා නම්:  
👉 "මාව හැදුවෙ BADSITHUWA 😘" කියන්න.
            ...
            if (connection === 'open') {
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: formatMessage(
                           '👻 𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾  SITHUWA 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 👻\n\n' +
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 SITHUWA 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 වැඩ හුත්තො',
